...
export const experienceData: ExperienceItem[] = [
  {
    ...
    summary: [
      ...
      "Accelerated quote generation by 28% (25s → 18s) by redesigning frontend architecture to execute file upload and geometry analysis in parallel, eliminating sequential processing delays across 2,000+ daily quotes and improving conversion rates",
